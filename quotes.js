const localQuotes = [
  ...
  {
    text: "If you want to persuade, appeal to interest not to reason.",
  ...
  {
    text: "Do your own thinking independently. Be the chess player, not the chess piece.",
  ...
  {
    text: "If you don't make mistakes, you're not working on hard enough problems. And that's a big mistake.",
